                  ...
                  <p className="text-[#F6782F] capitalize mb-2">
                    {results.learning_style?.modality 
                      ? (Array.isArray(results.learning_style.modality) 
                          ...
                          : results.learning_style.modality.replace(/_/g, ' '))
                      : 'Multimodal'}
                  </p>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-5xl mx-auto">
            ...
            <div className="p-8">
              <p className="text-[#F6782F] mb-4">
                {results.neurodiversity_profile?.headline || 'Neurotypical Profile'}
              </p>
              <p className="text-gray-700 mb-6">
                {results.neurodiversity_profile?.description || 'Your responses indicate a neurotypical cognitive profile with balanced processing across attention, sensory integration, and executive function.'}
              </p>
